...
#Question 5 ----
whole_text %>% 
  str_replace_all("(Winston|Smith)+", "REDACTED")
```
...
```{r}
#Question 6 ----
#Use (?i) to capture all cases of gin
#Use [:punct:] to capture any with punctuation after them
#Extract them first
whole_text %>% 
  str_extract_all("(?i) gin[ [:punct:]]")
